...
`mc32.exe` can be used from the command line with scripts. See here for more details ; [https://github.com/ABelliqueux/nolibgs_hello_worlds/wiki/STR#via-the-command-line](https://github.com/ABelliqueux/nolibgs_hello_worlds/wiki/STR#via-the-command-line)
